...
@onready var item_description_label: Label = $MarginContainer/HBoxContainer/VSplitContainer/DescriptionNinePatchRect/HBoxContainer/ItemDescriptionLabel
@onready var item_extra_info_label: Label = $MarginContainer/HBoxContainer/VSplitContainer/DescriptionNinePatchRect/HBoxContainer/ItemExtraInfoLabel
@onready var scrap_slot: TextureRect = $MarginContainer/HBoxContainer/VSplitContainer/DescriptionNinePatchRect/HBoxContainer/ScrapSlot

...
const VALID_MATERIAL = preload("res://resources/materials/constructable_invalid_material.tres")
const INVALID_MATERIAL = preload("res://resources/materials/constructable_valid_material.tres")
...
func set_preview_material(material):
